...
namespace Services.Security
{
    public class SecurityService : ISecurityService
    {
        ...
        private const int MINIMUM_SALT_LENGTH = 8;
        ...
        public byte[] HashSaltedPassword(byte[] Password, byte[] Salt, HashAlgorithm HashAlgorithm)
        {
            ...
            {
                throw new ArgumentException(string.Format("Password is required to be at least {0} characters in length.", MINIMUM_PASSWORD_LENGTH));
            }
        ...
        public bool IsValidPassword(byte[] AttemptedPassword, byte[] ActualPassword)
        {
            #region Parameter Validation.
